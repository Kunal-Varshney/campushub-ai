...
//                 className="w-full pl-11 pr-12 py-3.5 bg-slate-900/90 backdrop-blur-2xl border border-slate-800/80 rounded-2xl text-slate-200 text-sm placeholder-slate-500 focus:outline-none focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 transition-all shadow-inner"
//               />
//               <div className="absolute right-3 top-1/2 -translate-y-1/2 hidden sm:flex items-center gap-0.5 px-2 py-0.5 rounded bg-slate-950 border border-slate-800 text-[10px] text-slate-500 font-mono">
...
//             {/* Navigation Tabs Bar */}
//             <div className="flex items-center justify-between bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-2">
...
//                     className={`flex items-center gap-2 px-3.5 py-2 rounded-2xl text-xs font-medium whitespace-nowrap border transition-all ${
//                       isActive
...
//                     <span>{cat.label}</span>
//                     <span className="px-1.5 py-0.2 rounded-full bg-slate-950 border border-slate-800 text-[10px]">
//                       {cat.count}
//                     </span>
//                   </button>
//                 );
...
//             <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-5 space-y-4 shadow-xl">
//               <div className="flex items-center gap-3">
//                 <img
...
//                 <button
//                   onClick={() => setIsCreatingPost(true)}
//                   className="flex-1 text-left px-4 py-3 bg-slate-950/80 border border-slate-800/80 rounded-2xl text-xs sm:text-sm text-slate-500 hover:text-slate-300 hover:border-slate-700 transition-all"
//                 >
...
//                 <button
//                   onClick={() => setIsCreatingPost(true)}
//                   className="px-4 py-2 rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-cyan-300 font-semibold hover:bg-cyan-500/20 transition"
//                 >
//                   New Post
//                 </button>
//               </div>
...
//                         className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-6 space-y-5 hover:border-slate-700/80 transition-all shadow-xl relative overflow-hidden"
//                       >
//                         {/* Pinned Ribbon Badge */}
//                         {post.pinned && (
//                           <div className="flex items-center gap-1.5 text-[11px] font-bold text-cyan-400 bg-cyan-500/10 border border-cyan-500/20 px-3 py-1 rounded-full w-fit">
...
//                                 )}
//                                 <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-slate-950 border border-slate-800 text-slate-400">
//                                   {post.author.badge}
//                                 </span>
//                               </div>
...
//                           <span className="px-3 py-1 rounded-full text-xs font-semibold bg-slate-950 border border-slate-800 text-cyan-300">
//                             {post.categoryLabel}
//                           </span>
//                         </div>
...
//                           <h3 className="text-lg font-bold text-white leading-snug hover:text-cyan-300 transition cursor-pointer">
//                             {post.title}
//                           </h3>
...
//                         {post.imageUrl && (
//                           <div className="rounded-2xl overflow-hidden border border-slate-800 max-h-80 relative">
//                             <img
//                               src={post.imageUrl}
//                               alt="Post attachment"
...
//                         {post.codeSnippet && (
//                           <div className="bg-slate-950 rounded-2xl p-4 border border-slate-800/80 font-mono text-xs overflow-x-auto text-cyan-200 leading-relaxed relative">
//                             <div className="flex justify-between items-center pb-2 mb-2 border-b border-slate-900 text-[10px] text-slate-500">
//                               <span>CODE SNIPPET</span>
//                               <button
//                                 onClick={() => {
...
//                         {/* Interactive Poll Attachment (if present) */}
//                         {post.poll && (
...
//                                   >
//                                     <div
//                                       className="absolute left-0 top-0 bottom-0 bg-cyan-500/15 pointer-events-none transition-all"
...
//                             <span
//                               key={i}
//                               className="px-2.5 py-1 rounded-lg bg-slate-950 border border-slate-800/80 text-[11px] text-slate-400 font-medium"
//                             >
//                               #{tag}
//                             </span>
//                           ))}
...
//                               className="flex items-center gap-1.5 py-1.5 px-3 rounded-xl bg-slate-950 border border-slate-800 text-slate-400 hover:text-white transition"
//                             >
...
//                                   }}
//                                   className="flex-1 px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-cyan-500/50"
//                                 />
//                                 <button
...
//                                     <div
//                                       key={comment.id}
//                                       className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-3.5 space-y-1.5"
//                                     >
...
//                   return (
//                     <div key={idx} className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-6 space-y-4 hover:border-slate-700 transition-all">
...
//                         <span className="text-slate-500">{g.members}</span>
//                         <button onClick={() => alert(`Joined ${g.name}!`)} className="px-4 py-2 rounded-xl bg-slate-950 border border-slate-800 text-cyan-400 font-semibold hover:bg-slate-900 transition">
//                           Join Guild
//                         </button>
//                       </div>
//                     </div>
...
//                   <div key={evt.id} className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-slate-700 transition-all">
...
//               <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-6 space-y-4">
//                 <h3 className="text-lg font-bold text-white flex items-center gap-2">
//                   <Award className="w-5 h-5 text-cyan-400" /> Top Community Contributors
//                 </h3>
//                 <div className="space-y-3">
//                   {LEADERBOARD.map((item, idx) => (
//                     <div key={idx} className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-4 flex items-center justify-between">
//                       <div className="flex items-center gap-3">
...
//                     className="w-full flex items-center justify-between p-2.5 rounded-2xl bg-slate-950/60 border border-slate-800/80 hover:border-slate-700 transition text-left text-xs"
//                   >
...
//                 </h3>
//                 <button onClick={() => setActiveTab('events')} className="text-xs text-cyan-400 hover:underline">
//                   View All
//                 </button>
//               </div>
...
//               <div className="space-y-3">
//                 {UPCOMING_EVENTS.map((evt) => (
//                   <div key={evt.id} className="bg-slate-950/70 border border-slate-800/80 rounded-2xl p-3.5 space-y-1">
...
//                         </div>
//                       </div>
//                       <button onClick={() => alert(`Joined ${g.name}!`)} className="px-3 py-1 rounded-xl bg-slate-950 border border-slate-800 text-[11px] font-semibold text-cyan-400 hover:bg-slate-900 transition">
//                         Join
//                       </button>
//                     </div>
//                   );
...
//           <div className="space-y-3">
//             {FAQS.map((faq, idx) => (
//               <div key={idx} className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-5 space-y-2">
...
//                 <div className="space-y-1">
//                   <label className="text-xs font-semibold text-slate-300">Content / Question</label>
//                   <textarea
//                     required
//                     rows={4}
