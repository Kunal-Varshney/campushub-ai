...
const features = [
  {
    ...
    desc: "Our AI compares your skills and goals against thousands of listings to find the closest fit.",
  },
  {
    icon: Sparkles,
    title: "Smart Recommendations",
    desc: "Get a hand-picked shortlist that updates as your profile and preferences evolve.",
  },
  {
    icon: ShieldCheck,
    title: "Verified Companies",
    desc: "Every listing comes from a company that has been checked for legitimacy.",
  },
  {
    icon: FileCheck2,
    title: "Resume Match Score",
    desc: "See exactly how well your resume aligns with each internship before you apply.",
  },
  {
    icon: Zap,
    title: "Instant Apply",
    desc: "Apply to internships in a single click using your CampusHub AI profile.",
  },
  {
    icon: Bell,
    title: "Real-Time Alerts",
    desc: "Get notified the moment a role matching your skills goes live.",
  },
];
...
const steps = [
  {
    ...
    icon: ClipboardList,
    title: "Enter Skills",
    desc: "Tell us your skills, role and location preferences.",
  },
  {
    number: "02",
    icon: Brain,
    title: "AI Analysis",
    desc: "Our AI studies your profile against live internship listings.",
  },
  {
    number: "03",
    icon: Target,
    title: "Find Best Match",
    desc: "Get a ranked shortlist of the internships that fit you best.",
  },
  {
    number: "04",
    icon: Rocket,
...
const benefits = [
  {
    icon: Brain,
    title: "AI Matching",
    desc: "Matched to roles based on real skill overlap, not keywords alone.",
  },
  {
    icon: Clock,
    title: "Save Time",
    desc: "Skip endless scrolling with a shortlist built for you.",
  },
  {
    icon: TrendingUp,
    title: "Higher Selection Chance",
    desc: "Apply to roles you're genuinely a strong fit for.",
  },
  {
    icon: ShieldCheck,
    title: "Verified Listings",
    desc: "Every internship is checked before it reaches your feed.",
  },
  {
    icon: Users,
    title: "Career Growth",
    desc: "Build real experience that strengthens your placement profile.",
  },
  {
    icon: Calendar,
    title: "Daily Updates",
    desc: "Fresh internships added and matched to you every day.",
  },
];
...
function extractInternshipList(response) {
  ...
  if (Array.isArray(response?.data?.internships)) {
...
function normalizeInternship(item = {}) {
  const skills = Array.isArray(item.skills)
    ? item.skills.filter(Boolean).map(String)
...
function MatchBadge({ score }) {
  ...
  return (
    <span
      className={`flex items-center gap-1 rounded-full border px-2.5 py-0.5 text-xs font-medium ${color}`}
    >
      ...
      try {
        ...
        */
        ...
        const backendSavedIds =
          response?.savedIds ||
          response?.savedInternshipIds ||
          response?.data?.savedIds ||
        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl">
              Let AI find your best-fit internship
            </h2>

            <p className="mt-3 text-slate-400">
              Enter your details and get matched instantly.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-6">
              ...
              >
                ...
                <option value="Below 25k">
                  Below 25k
                </option>

                <option value="25k - 40k">
                  25k - 40k
                </option>

                <option value="Above 40k">
                  Above 40k
                </option>
              </select>
