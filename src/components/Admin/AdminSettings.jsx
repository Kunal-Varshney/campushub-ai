...
const avatarSeeds = ["Admin", "Nova", "Orion", "Luna", "Atlas", "Phoenix"];
...
const ToggleSwitch = ({ enabled, onChange, label, description }) => (
  <div className="flex items-center justify-between gap-4 py-4 border-b border-white/5 last:border-b-0">
    ...
    <button
      ...
      className={`relative shrink-0 h-6 w-11 rounded-full transition-colors duration-300 ${
        enabled
...
// Section wrapper for consistent spacing/heading
...
const AdminSettings = () => {
  ...
  const handleToggle2FA = (val) => {
    setTwoFA(val);
    showToast(val ? "2FA is active" : "2FA is disabled");
  };
              ...
              {activeTab === "profile" && (
                <div>
                  ...
                  <div className="flex items-center gap-4 mb-8">
                    <div className="h-20 w-20 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white text-2xl font-bold border border-white/10 shadow-lg shadow-black/30 overflow-hidden transition-transform duration-300">
                      {avatar ? (
                        <img
                          src={avatar}
                          alt="Admin avatar"
                  ...
                  <SettingsSection title="Two-Factor Authentication">
                    ...
                    <div className="pb-4 pt-1">
                      ...
                      >
                        ...
                        {twoFA ? "2FA is active" : "2FA is disabled"}
                      </div>
                    </div>
                  </SettingsSection>
                ...
                <div>
                  ...
                  <SettingsSection>
                    ...
                    <ToggleSwitch
                      ...
                      onChange={(val) =>
                        toggleNotification("systemUpdates", val)
                      }
                ...
                <div>
                  ...
                  <SettingsSection title="Access Permissions">
                    <ToggleSwitch
                      ...
                      onChange={(val) =>
                        togglePermission("manageUsers", val)
                      }
                      label="Manage Users"
                    ...
                    <ToggleSwitch
                      ...
                      onChange={(val) =>
                        togglePermission("manageNotes", val)
                      }
                      label="Manage Notes"
                      description="Approve, edit, or delete uploaded notes"
                    />
                    <ToggleSwitch
                      enabled={permissions.viewAnalytics}
                      onChange={(val) =>
                        togglePermission("viewAnalytics", val)
                      }
                    ...
                    <div className="py-4 space-y-3">
                      <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                        ...
                        <div>
                          ...
                          <p className="text-slate-500 text-xs">
                            Full control over student and admin accounts
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                        ...
                        <div>
                          ...
                          <p className="text-slate-500 text-xs">
                            Review and moderate uploaded study material
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
