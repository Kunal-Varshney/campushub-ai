...
function CTA() {
  return (
    ...
    >
      {/* Background — same language as Hero / Features / Stats / Testimonials / FAQ */}
        ...
        >
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <button
                type="button"
                className="group/btn flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 px-7 py-3.5 font-semibold transition-all duration-300 hover:-translate-y-1 hover:from-blue-500 hover:to-cyan-400 hover:shadow-2xl hover:shadow-blue-500/30 active:scale-95"
              >
                Get Started
                <ArrowRight
                  size={18}
              ...
              <button
                type="button"
                className="group/btn flex items-center gap-3 rounded-xl border border-slate-700 bg-slate-900/70 px-7 py-3.5 font-semibold transition-all duration-300 hover:border-blue-500 hover:bg-slate-800 hover:shadow-xl hover:shadow-blue-500/20"
              >
                <PlayCircle
                  size={21}
